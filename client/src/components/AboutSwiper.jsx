  ...
  return (
    <div className='z-10 w-90%  flex items-center justify-center flex-col'>
     ...
     1200 : {slidesPerView:5,
      ...
      >
        {props.Image.map((e)=>{
               return   <SwiperSlide key={e.id} className=' m-1 bg-gray-200 shadow-md hover:border-2 border-gray-400  h-[32vh] relative lg:h-[22vw]'>
                ...
                <div className=' m-2 lg:p-1 h-[7vh]'>
